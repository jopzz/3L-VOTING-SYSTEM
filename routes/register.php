<html>
    <head>
        <title>3L voting system - Registratrion</title>
            ...
            <h2>Registration</h2>
                <form action="../api/register.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="upload" style="width: 30%">
                        Upload Finger Print: <input type="file" id="profile" name="image" required>
                    </div><br>
                    <div id="upload" style="width: 30%">
                        Upload Iris: <input type="file" id="profile" name="image" required>
                    </div><br>
                    <div id="upload" style="width: 30%">
                        Select your role:
                        <select name="role">
